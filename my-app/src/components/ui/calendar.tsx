  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "z-10 select-none font-medium relative before:content-[''] before:absolute before:inset-x-0 before:bottom-[2px] before:h-[40%] before:bg-[var(--accent)] before:rounded-xs before:-z-1",
          captionLayout === "label"
            ? "text-sm"
